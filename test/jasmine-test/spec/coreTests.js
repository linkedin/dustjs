    ...
    tests: [
      {
        ...
        log: "invalid filter [v]",
        message: "test the log messages for an invalid filter."
      },
      {
      ...
      },
      {
        ...
        source:"{wrongTest}",
        context: {"test": "example text"},
        log: "reference for element was not found.",
      ...
      },
      {
        ...
        context: {"test": "example text"},
        log: "can not handle the element given for the section tag",
        message: "test the log messages for an unhandled section."
      },
      {
        name: "Invalid helper",
        source:"{@fakeHelper}{/fakeHelper}",
        context: {},
        log: "invalid helper [fakeHelper]",
        message: "test the log messages for an invalid helper."
      },
      {
        name: "No render for exists",
        source:"{?doesNotExist}{/doesNotExist}",
        context: {},
        log: "not rendering body or skip for exists check",
      ...
      },
      {
        ...
        log: "not rendering body or skip for not exists check",
        message: "test the log messages for an existing not exists check."
      },
      {
        name: "Context upward search",
        source:"{#foo}{baz}{/foo}",
        context:  {
                    baz: 'foo',
                    foo: {
        ...
        log: "Looking for [{baz}] up the context stack",
        message: "test the log messages for an upward context search."
      },
      {
        name: "Context search context not an object",
        source:"{baz}",
        context:  null,
        log: "current context is not an object.  Cannot find value for [{baz}]",
      ...
      },
      {
        ...
        log: "Looking for [{tryGlobal}] in the globals",
