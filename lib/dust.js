...
(function(dust) {
  ...
  Context.prototype._get = function(cur, down) {
    ...
    dust.log('Searching for reference [{' + down.join('.') + '}] in template [' + this.__templateName + ']', DEBUG);
    first = down[0];
    len = down.length;
    ...
    if (typeof ctx === 'function') {
      ...
      if (ctx === undefined) {
        dust.log('Cannot find the value for reference [{' + down.join('.') + '}] in template [' + this.__templateName + ']');
      }
      return ctx;
    }
  };
  ...
  Context.prototype.push = function(head, idx, len) {
    return new Context(new Stack(head, this.stack, idx, len), this.global, this.blocks, this.__templateName);
  };

  Context.prototype.rebase = function(head) {
    return new Context(new Stack(head), this.global, this.blocks, this.__templateName);
  };
  ...
  Context.prototype.getBlock = function(key, chk, ctx) {
    ...
    if (!blocks) {
      dust.log('No blocks for context[{' + key + '}] in template [' + this.__templateName + ']', DEBUG);
      return;
    }
  ...
  Context.prototype.shiftBlocks = function(locals) {
    ...
    if (locals) {
      ...
      return new Context(this.stack, this.global, newBlocks, this.__templateName);
    }
    return this;
  };
  ...
  Chunk.prototype.section = function(elem, context, bodies, params) {
    ...
    */
    ...
    dust.log('Not rendering section (#) block in template [' + context.__templateName + '], because above key was not found', DEBUG);
    return this;
  };
  ...
  Chunk.prototype.exists = function(elem, context, bodies) {
    ...
    dust.log('Not rendering exists (?) block in template [' + context.__templateName + '], because above key was not found', DEBUG);
    return this;
  };
  ...
  Chunk.prototype.notexists = function(elem, context, bodies) {
    ...
    dust.log('Not rendering not exists (^) block check in template [' + context.__templateName + '], because above key was found', DEBUG);
    return this;
  };
  ...
  Chunk.prototype.partial = function(elem, context, params) {
    ...
    if(typeof elem === 'string') {
      partialContext.__templateName = elem;
    }
