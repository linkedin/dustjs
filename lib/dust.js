...
Context.prototype.getPath = function(cur, down) {
  ...
  ctx = ctx.head;
  // A section iteration pushes each element on the context. If any element is falsey,
  // the test below will fail and exit following the down path prematurely.  Force
  // any non-falsey value to prevent that. Other than being non-falsey, the value does not matter.
  if (!ctx) {
    ctx = 42;
  }
  var i = 0;
