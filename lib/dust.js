...
dust.filters = {
  ...
  u: function(value) { return dust.escapeHref(value); },
  uc: function(value) { return dust.encodeURIComponent(value); },
  js: function(value) { return dust.JSONstringify(value); },
  jp: function(value) { if (typeof(JSON) === 'undefined') { return value; } return JSON.parse(value); }
};
...
// standard function replaced in dust.escapeJs
