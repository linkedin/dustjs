...
dust.escapeJs = (function() {
	...
	var encodeChar = function(c) {
		...
		return index[c] === undefined ? index[c] = '\\u' + ('000' + c.charCodeAt(0).toString(16)).slice(-4) : index[c];
	};
