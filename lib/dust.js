  ...
  while(ctx) {
    if(ctx.isObject) {
      ...
      if( value !== undefined ) {
        ...
        // If value is a function then wrap in a closure that captures the object
        // the function should be invoked on. This is necessary because the Chunk
        // 'section' and 'reference' don't otherwise properly resolve the object
        // when getPath is used.
