...
(function(root, factory) {
  if (typeof exports === 'object') {
    ...
    // @see server file for compiler methods exposed in node
  } else {
    var compiler = factory(root.dust.parse);
    //expose compiler methods to the browser
    root.dust.compile = compiler.compile;
    root.dust.filterNode = compiler.filterNode;
    root.dust.optimizers = compiler.optimizers;
    // these are currenlty in the API
    root.dust.pragmas = compiler.pragmas;
    root.dust.compileNode = compiler.compileNode;
    root.dust.nodes = compiler.nodes;
  ...
  if (Array.isArray) {
    compiler.isArray = Array.isArray;
  } else {
    compiler.isArray = function(arr) {
