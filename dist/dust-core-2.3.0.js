...
(function(dust) {
  ...
  Context.prototype._get = function(cur, down) {
    ...
    if (typeof ctx === 'function') {
      ...
      if (ctx === undefined) {
        dust.log('Cannot find the value for reference [{' + down.join('.') + '}] in template [' + this.__template_name__ + ']');
      }
      return ctx;
    }
  };
  ...
  Context.prototype.push = function(head, idx, len) {
    return new Context(new Stack(head, this.stack, idx, len), this.global, this.blocks, this.__template_name__);
  };

  Context.prototype.rebase = function(head) {
    return new Context(new Stack(head), this.global, this.blocks, this.__template_name__);
  };
  ...
  Context.prototype.getBlock = function(key, chk, ctx) {
    ...
    if (!blocks) {
      dust.log('No blocks for context[{' + key + '}] in template [' + this.__template_name__ + ']', DEBUG);
      return;
    }
  ...
  Context.prototype.shiftBlocks = function(locals) {
    ...
    if (locals) {
      ...
      return new Context(this.stack, this.global, newBlocks, this.__template_name__);
    }
    return this;
  };

  Context.prototype.getTemplateName = function() {
    return this.__template_name__;
  }
  ...
  Chunk.prototype.section = function(elem, context, bodies, params) {
    ...
    */
    ...
    dust.log('Not rendering section (#) block in template [' + context.__template_name__ + '], because above key was not found', DEBUG);
    return this;
  };
  ...
  Chunk.prototype.exists = function(elem, context, bodies) {
    ...
    dust.log('Not rendering exists (?) block in template [' + context.__template_name__ + '], because above key was not found', DEBUG);
    return this;
  };
  ...
  Chunk.prototype.notexists = function(elem, context, bodies) {
    ...
    dust.log('Not rendering not exists (^) block check in template [' + context.__template_name__ + '], because above key was found', DEBUG);
    return this;
  };
  ...
  Chunk.prototype.partial = function(elem, context, params) {
    ...
    if(typeof elem === 'string') {
      partialContext.__template_name__ = elem;
    }
    ...
    if (typeof elem === 'function') {
      partialChunk = this.capture(elem, partialContext, function(name, chunk) {
        partialContext.__template_name__ = partialContext.__template_name__ || name;
