//
// Dust - Asynchronous Templating v1.3.0
...
dust.filter = function(ctx, string, auto, filters) {
  var context = {"auto": auto};
  if (filters) {
      ...
      // fail silently for invalid filters
        ...
        for(var p=0; p<params.length; p++) {
            if(typeof params[p] === "function") {
                params[p] = params[p](new Chunk(), ctx).data.join('');
            }
        }
        string = dust.filters[name].apply(this, [string, context].concat(params));
      }
    }
  }
  // by default always apply the h filter, unless asked to unescape with |s
  if (context.auto) {
    string = dust.filters[context.auto](string);
  }
  return string;
};
...
dust.filters = {
  ...
  replace: function(value, context, from, to) {
      if(from && to) {
  ...
  link_to: function(value, context, link, title) {
      title = title || "";
      if(link) {
          context.auto = null;
          return '<a href="' + link.trim() + '" title="' + title + '">' + value + '</a>';
      } else {
          return value;
      }
  }
...
Chunk.prototype.reference = function(elem, context, auto, filters) {
  ...
  if (!dust.isEmpty(elem)) {
    return this.write(dust.filter(context, elem, auto, filters));
  } else {
    return this;
  }
};
  ...
  filters: function(context, node) {
    ...
    for (var i=1, len=node.length; i<len; i++) {
      ...
      if(typeof filter === "string") {
        ...
        var params = [];
        for(var p=0; p<filter[1].length; p++) {
            params.push(dust.compileNode(context, filter[1][p]));
        }
        list.push("[\"" + filter[0] + "\"," + params.join(",") + "]");
      }
    }
    return "\"" + context.auto + "\""
                ...
                if (result5 !== null) {
                  ...
                  if (result6 !== null) {
                    ...
                    if (result7 !== null) {
                        ...
                        if (result10 !== null) {
                          ...
                          if (result11 !== null) {
                            ...
                            if (result12 !== null) {
                              ...
                              if (result13 !== null) {
                                result11 = [result11, result12, result13];
                              } else {
                                result11 = null;
                                pos = clone(pos7);
                              }
                      ...
                      if (result9 !== null) {
                        result9 = (function(offset, line, column, param) {return param})(pos5.offset, pos5.line, pos5.column, result9[1]);
                      }
                      if (result9 === null) {
                        pos = clone(pos5);
                      }
                  ...
                  if (result6 !== null) {
                    result6 = (function(offset, line, column, p) {return p})(pos3.offset, pos3.line, pos3.column, result6[2]);
                  }
                  if (result6 === null) {
                    pos = clone(pos3);
                  }
