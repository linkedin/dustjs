...
var n = this.stack, r = t.length;
if (e && r === 0) return n.head;
if (!n.isObject) return undefined;
n = n.head;
var i = 0;
while (n && i < r) n = n[t[i]], i++;
return n;
...
typeof e == "function" && (e = e(t, n).data, t.data = "");
var r = this.blocks;
if (!r) return;
var i = r.length, s;
while (i--) {
...
for (var a = 0; a < o; a++) u = i(u, t.push(e[a], a, o));
return u;
}
} else if (e === !0) {
...
var r = t.stack, i = r.head;
return n && (t = t.rebase(r.tail), t = t.push(n), t = t.push(i)), typeof e == "function" ? this.capture(e, t, function(e, n) {
dust.load(e, n, t).end();
}) : dust.load(e, this, t);
...
})(dust), typeof exports != "undefined" && (dust.helpers = require("../dustjs-helpers/lib/dust-helpers").helpers, typeof process != "undefined" && require("./server")(dust), module.exports = dust), function(dust) {
function isSelect(e) {
var t = e.current();
...
var r = r || {}, s, o;
if (r.key) s = helpers.tap(r.key, e, t); else {
if (!isSelect(t)) throw "No key specified for filter and no key found in context from select statement";
s = t.current().selectKey, t.current().isResolved && (i = function() {
return !1;
});
}
return o = helpers.tap(r.value, e, t), i(o, coerce(s, r.type, t)) ? (isSelect(t) && (t.current().isResolved = !0), e.render(n.block, t)) : n["else"] ? e.render(n["else"], t) : e.write("");
}
...
contextDump: function(e, t, n) {
return _console.log(JSON.stringify(t.stack)), e;
},
tap: function(e, t, n) {
var r = e;
return typeof e == "function" && (r = "", t.tap(function(e) {
return r += e, "";
...
if (bodies["else"]) return chunk.render(bodies["else"], context);
} else _console.log("No condition given in the if helper!");
return chunk;
},
select: function(e, t, n, r) {
if (r && r.key) {
var i = this.tap(r.key, e, t);
return e.render(n.block, t.push({
isSelect: !0,
isResolved: !1,
selectKey: i
}));
...
eq: function(e, t, n, r) {
return filter(e, t, n, r, function(e, t) {
return t === e;
});
},
lt: function(e, t, n, r) {
...
}(typeof exports != "undefined" ? exports : getGlobal()), function(e) {
function t(t) {
var n = {};
...
if (e !== null) {
t = [], r = W();
while (r !== null) t.push(r), r = W();
t !== null ? (r = U(), r !== null ? (i = d(), i !== null ? (u = E(), u !== null ? (a = y(), a !== null ? (f = function(e, t, n, r, i, s, o) {
return r[1].text === o.text;
...
if (t !== null) {
m = c(s), r = M(), r !== null && (r = function(e, t, n, r) {
return [ "literal", r ];
}(m.offset, m.line, m.column, r)), r === null && (s = c(m)), r === null && (r = P());
if (r !== null) {
i = b();
if (i !== null) {
u = w();
if (u !== null) {
a = [], f = W();
while (f !== null) a.push(f), f = W();
a !== null ? (n.charCodeAt(s.offset) === 47 ? (f = "/", h(s, 1)) : (f = null, o === 0 && p('"/"')), f !== null ? (l = U(), l !== null ? e = [ e, t, r, i, u, a, f, l ] : (e = null, s = c(v))) : (e = null, s = c(v))) : (e = null, s = c(v));
} else e = null, s = c(v);
} else e = null, s = c(v);
} else e = null, s = c(v);
} else e = null, s = c(v);
...
var u = r === ">" ? "partial" : r;
return [ u, i, s, o ];
}(d.offset, d.line, d.column, e[1], e[2], e[3], e[4])), e === null && (s = c(d)), o--, o === 0 && e === null && p("partial"), e;
}
function T() {
var e, t, r, i, u, a;
...
if (r !== null) {
t = [];
while (r !== null) t.push(r), r = _(), r === null && (r = D());
} else t = null;
t !== null ? e = [ e, t ] : (e = null, s = c(u));
} else e = null, s = c(u);
return e !== null && (e = function(e, t, n, r, i) {
return i = i[0], r && i ? (i.unshift(r), [ !1, i ]) : [ !0, i ];
}(i.offset, i.line, i.column, e[0], e[1])), e === null && (s = c(i)), e === null && (i = c(s), n.charCodeAt(s.offset) === 46 ? (e = ".", h(s, 1)) : (e = null, o === 0 && p('"."')), e !== null && (e = function(e, t, n) {
return [ !0, [] ];
}(i.offset, i.line, i.column)), e === null && (s = c(i))), o--, o === 0 && e === null && p("path"), e;
}
function M() {
var e, t, r, i, u;
...
return e !== null ? (t = D(), t = t !== null ? t : "", t !== null ? e = [ e, t ] : (e = null, s = c(u))) : (e = null, s = c(u)), e !== null && (e = function(e, t, n, r, i) {
return i ? r.concat(i) : r;
}(i.offset, i.line, i.column, e[0], e[1])), e === null && (s = c(i)), o--, o === 0 && e === null && p("nestedKey"), e;
}
function D() {
var e, t, r, i, u, a, f;
o++, i = c(s), u = c(s), a = c(s), f = c(s), n.charCodeAt(s.offset) === 91 ? (e = "[", h(s, 1)) : (e = null, o === 0 && p('"["'));
if (e !== null) {
/^[0-9]/.test(n.charAt(s.offset)) ? (r = n.charAt(s.offset), h(s, 1)) : (r = null, o === 0 && p("[0-9]"));
if (r !== null) {
t = [];
while (r !== null) t.push(r), /^[0-9]/.test(n.charAt(s.offset)) ? (r = n.charAt(s.offset), h(s, 1)) : (r = null, o === 0 && p("[0-9]"));
} else t = null;
t !== null ? (n.charCodeAt(s.offset) === 93 ? (r = "]", h(s, 1)) : (r = null, o === 0 && p('"]"')), r !== null ? e = [ e, t, r ] : (e = null, s = c(f))) : (e = null, s = c(f));
} else e = null, s = c(f);
return e !== null && (e = function(e, t, n, r) {
return r.join("");
}(a.offset, a.line, a.column, e[1])), e === null && (s = c(a)), e !== null ? (t = _(), t = t !== null ? t : "", t !== null ? e = [ e, t ] : (e = null, s = c(u))) : (e = null, s = c(u)), e !== null && (e = function(e, t, n, r, i) {
...
while (i !== null) r.push(i), i = W();
if (r !== null) {
d = c(s), v = c(s), o++, u = U(), o--, u === null ? u = "" : (u = null, s = c(v)), u !== null ? (v = c(s), o++, a = z(), o--, a === null ? a = "" : (a = null, s = c(v)), a !== null ? (n.length > s.offset ? (f = n.charAt(s.offset), h(s, 1)) : (f = null, o === 0 && p("any character")), f !== null ? u = [ u, a, f ] : (u = null, s = c(d))) : (u = null, s = c(d))) : (u = null, s = c(d));
if (u !== null) {
i = [];
while (u !== null) i.push(u), d = c(s), v = c(s), o++, u = U(), o--, u === null ? u = "" : (u = null, s = c(v)), u !== null ? (v = c(s), o++, a = z(), o--, a === null ? a = "" : (a = null, s = c(v)), a !== null ? (n.length > s.offset ? (f = n.charAt(s.offset), h(s, 1)) : (f = null, o === 0 && p("any character")), f !== null ? u = [ u, a, f ] : (u = null, s = c(d))) : (u = null, s = c(d))) : (u = null, s = c(d));
} else i = null;
if (i !== null) {
u = [], a = W();
while (a !== null) u.push(a), a = W();
...
function W() {
var e;
return /^[\t\x0B\f \xA0\uFEFF]/.test(n.charAt(s.offset)) ? (e = n.charAt(s.offset), h(s, 1)) : (e = null, o === 0 && p("[\\t\\x0B\\f \\xA0\\uFEFF]")), e === null && (e = z()), e;
}
function X(e) {
e.sort();
var t = null, n = [];
...
if (V === null || s.offset !== n.length) {
var $ = Math.max(s.offset, u.offset), J = $ < n.length ? n.charAt($) : null, K = s.offset > u.offset ? s : u;
throw new t.SyntaxError(X(a), J, $, K.line, K.column);
}
return V;
},
toSource: function() {
