module.exports = function (grunt) {
  ...
  grunt.initConfig({
      ...
      parser: {
        ...
        options: {
          wrapper: function (src, parser) {
            ...
            var wrapper = grunt.file
              .read("src/umdParserWrapper.js")
              .replace("@@build", buildMsg)
              .split("@@parser");
    ...
    log: {
      ...
      copyForRelease: {
        options: {
          message:
            "OK. Done copying version <%= pkg.version %> build from tmp to dist",
        },
      },
      release: {
        options: {
  ...
  grunt.registerTask(
    ...
    process.env.SAUCE_ACCESS_KEY
      ? ["jasmine:testProd:build", "connect:testServer", "saucelabs-jasmine"]
      : []
  );
  ...
  grunt.registerTask(
    "travis",
    process.env.TEST === "all" ? ["test", "sauce"] : ["testNode", "testCli"]
  );

  //task for debugging in browser
  grunt.registerTask("dev", [
    "build",
    "jasmine:testDev:build",
    "connect:testServer",
    "watch:lib",
  ]);
  ...
  //release tasks
  grunt.registerTask("copyForRelease", [
    "clean:dist",
    "copy",
    "log:copyForRelease",
  ]);
